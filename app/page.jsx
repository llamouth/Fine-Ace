    ...
    <div className="mt-40">
              ...
              <Card key={idx} className="p-6">
                <CardContent className="pt-4">
                  <div className="flex items-center mb-4">
                    <Image src={testimonial.image} width={40} height={40} alt={testimonial.name} className="rounded-full" />
                    <div className="ml-4">
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto"> Join Fine-Ace for better Finance</p>
          <Link href="/dashboard">
